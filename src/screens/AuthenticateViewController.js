        ...
        <TouchableWithoutFeedback
            ...
            >
                <View style={styles.container}>
                    <View style={{ flex: 1, alignItems: "flex-start", justifyContent: 'center', backgroundColor: 'green' }}>
                        <Text style={{ fontSize: 30, fontFamily: "Kollektif", }}>Email</Text>
                        ...
                        <View style={{ alignItems: "flex-start", marginTop: "2%", justifyContent: 'center' }}>
